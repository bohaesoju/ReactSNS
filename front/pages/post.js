    ...
    <>
      <Helmet
        ...
        meta={[{
          ...
          property: 'og:image', content: singlePost.Images[0] && singlePost.Images[0].src || `http://danceworld.shop/favicon.ico`,
        }, {
          property: 'og:url', content: `http://danceworld.shop/post/${id}`,
        }]}
      />
